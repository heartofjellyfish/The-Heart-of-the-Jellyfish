...
mistakes a rough bounce for the finished thing — hence `DEMO_STATE` / `DEMO_NOTE` above
the tracklist. Say what they are rather than letting a listener find out by disappointment.
